...
function clickdown(){rangeValue1.style.opacity = '1';}
function clickup(){rangeValue1.style.opacity = '0';}
...
function posRangeValue1(){
	//ширира дорожки - ширина элемента
	var widthBlock = (range1.clientWidth - rangeValue1.clientWidth) / 100;

	rangeValue1.style.transform = 'translateX(' + (range1.value / 2.55) * widthBlock + 'px)';
	rangeValue1.innerText = range1.value;

	range1.oninput = function(){
		rangeValue1.innerText = parseInt(this.value / 2.55);
		rangeValue1.style.transform = 'translateX(' + ((this.value / 2.55) * widthBlock) + 'px)';
