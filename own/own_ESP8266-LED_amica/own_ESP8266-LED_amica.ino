...
const char* ssid = "UPC9229449"; // имя вашей сети
const char* password = "vh4yWcuyxCwh"; // пароль вашей сети

IPAddress Ip(192,168,1,51); // IP-адрес для ESP
...
#define RELAY_PIN 4 // pin of a relay
...
void ledEffect(int ledMode){ 
    switch(ledMode){
      ...
      case 7: Fire(55, 120, delaySmart); delayValue = 15; break; 
      case 8: blueFire(55, 250, delaySmart); delayValue = 15; break;  
      case 9: random_burst(); delayValue = 20; break;
      case 10: flicker(); delayValue = 20; break;
      case 11: random_color_pop(); delayValue = 35; break;                                      
      case 12: Sparkle(255, 255, 255, delaySmart); delayValue = 0; break;                   
      ...
      case 19: flame(); break;
      case 20: theaterChase(255, 0, 0, delaySmart); delayValue = 50; break;
      case 21: Strobe(255, 255, 255, 10, delaySmart, 1000); delayValue = 100; break;
      ...
      case 30: LEDS.setBrightness(0); LEDS.show(); break;
      case 31: digitalWrite(RELAY_PIN, HIGH);; break;
      case 32: digitalWrite(RELAY_PIN, LOW);; break;
    }
}
