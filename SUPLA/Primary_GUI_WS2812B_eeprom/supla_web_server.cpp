...
String supla_webpage_start(int save) {
  ...
  if (nr_dht > 0 ) {
    ...
    content += "<div class='w'>";
    content += "<h3>Kontroler WS2812B </h3>";
    content += "<i><input name='supla_ws2812' value='" + String(read_supla_ws2812().c_str()) + "'length=";
    content += MAX_WS2812;
    content += "><label>Ilość diod</label></i>";      
    content += "</div>";
